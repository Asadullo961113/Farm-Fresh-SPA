...
export default function UserPage() {
  ...
  return (
    ...
    // console.log('Complete image URL:', `${serverApi}/${authMember?.memberImage}`),
                ...
                <img
                    src={
                      authMember?.memberImage
                        ? `${serverApi}/${authMember.memberImage}` // serverdan olingan rasm URL'ini qo'shish
                        : "/icons/default-user.svg"  // agar rasm bo'lmasa, default rasm
                    }
